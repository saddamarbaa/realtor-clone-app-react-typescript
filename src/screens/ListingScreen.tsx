...
export default function ListingScreen() {
  ...
  return (
    <section>
      ...
      <motion.div className='w-full p-4 py-8' initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <motion.div className='mx-auto flex w-full max-w-6xl cursor-pointer flex-col space-y-3 rounded-lg border bg-white p-4 shadow-lg md:flex-row lg:space-x-5 lg:space-y-0'>
          <motion.div
          ...
          <motion.div
            className='z-30 h-[230px] w-full overflow-hidden bg-pink-300 lg:h-[430px]'
            initial={{ y: 100, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          />
        </motion.div>
